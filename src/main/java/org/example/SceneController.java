...
public class SceneController {
    ...
    public void switchToHowToPlayOne(MouseEvent event) throws IOException {
    ...
    public void switchToHowToPlayTwo(MouseEvent event) throws IOException {
    ...
    public void switchToChooseCharacter(MouseEvent event) throws IOException {
    ...
    public void switchToLvlOne(MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getClassLoader().getResource("levelOne.fxml")));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
